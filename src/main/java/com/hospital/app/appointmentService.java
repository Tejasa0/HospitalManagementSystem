...
public class appointmentService {
		...
		public List<appointment> findByDoctorNameAndConfirmed(String doctorName, String string) {
			// TODO Auto-generated method stub
			return bookAppointment.findByDoctorNameAndConfirmed(doctorName,string);
		}

		public List<appointment> findConfirmedByAppointmentId(Integer id) {
			// TODO Auto-generated method stub
			return bookAppointment.findByAppointment_Id(id);
		}
